      ...
      <SafeAreaView style={styles.container}>
        <View style={styles.LoginScreenUpView}>
          ...
          <TouchableOpacity
            style={styles.touch}
            onPress={() => {
              this.setState({flag: SCREENS.LOGIN});
            }}
            disabled={this.state.flag === SCREENS.LOGIN ? true : false}>
            <Text style={styles.textLogin}>Login</Text>
            {this.state.flag === SCREENS.LOGIN ? (
          ...
          <TouchableOpacity
            style={styles.touch}
            onPress={() => {
              this.setState({flag: SCREENS.SIGN_UP});
            }}
            disabled={this.state.flag === SCREENS.SIGN_UP ? true : false}>
            <Text style={styles.textSignUp}>Sign-up</Text>
            {this.state.flag === SCREENS.SIGN_UP ? (
