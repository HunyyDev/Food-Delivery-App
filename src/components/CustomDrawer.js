...
import React, {useState, useRef, useContext, createContext, useMemo, useReducer} from 'react'
import COLOR from '../constants/colors'
import TabButton from './TabButton'
import { ICON_arrow, ICON_buy, ICON_guard, ICON_menu, ICON_note, ICON_offer, ICON_profile } from '../assets/icons/icons';
    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.tabView}>
                ...
                <View style={styles.holdPlace}></View>
                <TabButton currentTab={currentTab}
                ...
                <TouchableOpacity activeOpacity={0.8}
                    ...
                    <Image source={ICON_arrow} style={styles.icon}></Image>
                </TouchableOpacity>
            </View>
            <View style={styles.shadow} />

            {/* side navigation */}
            <Animated.View style={[styles.screenContainer(showMenu), {
                transform: [
                    { scale: scaleValue },
                    { translateX: offsetX }
                ],
                ...
                {/* Screen*/}
                <DrawnerContext.Provider value={{setStatus: (status) => setStatus(status)}}>
                {props.children}
