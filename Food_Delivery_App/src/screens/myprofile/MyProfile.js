         ...
         <View style={styles.goBackContainer}>
          ...
          <View >
           ...
           <View style={styles.viewPayment}>
            ...
            <TouchableOpacity onPress={()=>{setIsSelect('1')}} style={styles.touchCard}  >
              ...
              <View 
              style={styles.select} 
              backgroundColor={isSelect === '1' ? CUSTOM_COLORS.SunsetOrange : 'transparent'}>

              </View>
            </TouchableOpacity>

            {/*Button Bank */}
            <TouchableOpacity onPress={()=>{setIsSelect('2')}} style={styles.touchBank}  >
              <View style={styles.selectBorder}>
              </View>
              ...
              <View 
              style={styles.select} 
              backgroundColor={isSelect === '2' ? CUSTOM_COLORS.SunsetOrange : 'transparent'}>
                
              </View>
            </TouchableOpacity>

            {/*Button Paypal */}
            <TouchableOpacity onPress={()=>{setIsSelect('3')}} style={styles.touchPaypal}  >
              <View style={styles.selectBorder}>
              </View>
              ...
              <View 
              style={styles.select} 
              backgroundColor={isSelect === '3' ? CUSTOM_COLORS.SunsetOrange : 'transparent'}>
