...
import Custom_Boder from './component/boder';
import TextHead from './component/text';
    ...
    <SafeAreaView style={styles.container}>
      ...
      <>
        <View style={styles.view2}>
          ...
          <Text2 text="Total" fontWeight="400" top={scale(185)} />
